...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      // ATSbranchseq_beg
      case 3: // __atstmplab2
      if(ATSCKptrisnull(tmp72)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 2788(line=128, offs=3) -- 2962(line=136, offs=6)");
      case 4: // __atstmplab3
      tmp73 = create_enemy();
...
//
  ...
  tmp85 = enemy_getPosition_X(arg0);
  tmp86 = enemy_getPosition_Y(arg0);
  tmp87 = ats2jspre_add_double_double(tmp85, arg1);
  tmp88 = ats2jspre_add_double_double(tmp86, arg2);
  enemy_setPosition(arg0, tmp87, tmp88);
  tmp90 = enemy_check_crash(arg0, tmp87, tmp88);
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      // ATSbranchseq_beg
      case 3: // __atstmplab6
      if(!ATSCKpat_int(tmp90, 0)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 3804(line=167, offs=3) -- 4098(line=175, offs=6)");
      case 4: // __atstmplab7
      tmp91 = enemy_check_bound(arg0, tmp87, tmp88);
      // ATScaseofseq_beg
      tmplab_js = 1;
      while(true) {
        tmplab = tmplab_js; tmplab_js = 0;
        switch(tmplab) {
          ...
          if(!ATSCKpat_int(tmp91, 0)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 3943(line=172, offs=5) -- 4086(line=174, offs=85)");
...
//
  ...
  tmp94 = player_getPosition_X();
  tmp95 = player_getPosition_Y();
  tmp96 = enemy_getPosition_X(arg0);
  tmp97 = enemy_getPosition_Y(arg0);
  tmp99 = ats2jspre_eq_double_double(tmp94, tmp96);
  if(tmp99) {
    tmp98 = ats2jspre_eq_double_double(tmp95, tmp97);
  } else {
    tmp98 = false;
  } // endif
  if(tmp98) {
...
//
  ...
  tmp104 = ats2jspre_gt_double_double(arg1, 400.000000000000000000);
  if(tmp104) {
    tmp103 = true;
  } else {
    tmp103 = ats2jspre_lt_double_double(arg1, 0.0);
  } // endif
  if(tmp103) {
    tmp102 = true;
  } else {
    tmp102 = ats2jspre_gt_double_double(arg2, 500.000000000000000000);
  } // endif
  if(tmp102) {
    tmp101 = true;
  } else {
    tmp101 = ats2jspre_lt_double_double(arg2, 0.0);
  } // endif
  if(tmp101) {
    tmpret100 = 1;
  } else {
...
//
  // ATSdynload()
  // ATSdynloadflag_sta(_057_home_057_grad3_057_gladius_057_CS520_057_hwtest_057_SpaceInvaders_057_myGame_056_dats__dynloadflag(218))
