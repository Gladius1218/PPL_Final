...
//
  ...
  if(tmp20) {
    ...
    tmp23 = ats2jspre_add_int0_int0(tmp24, 2000);
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      // ATSbranchseq_beg
      case 3: // __atstmplab2
      if(ATSCKptrisnull(tmp71)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 2791(line=128, offs=3) -- 2935(line=135, offs=6)");
      case 4: // __atstmplab3
      tmp72 = create_enemy();
      set_enemy_animation(tmp72);
      break;
      // ATSbranchseq_end
    } // end-of-switch
...
//
  ...
  tmp74 = player_getPosition_X();
  tmp75 = player_getPosition_Y();
  tmp76 = enemy_getPosition_X(arg0);
  tmp77 = enemy_getPosition_Y(arg0);
  tmp79 = ats2jspre_mul_double_double(tmp76, 1.0);
  tmp78 = ats2jspre_sub_double_double(tmp74, tmp79);
  tmp81 = ats2jspre_mul_double_double(tmp76, 1.0);
  tmp80 = ats2jspre_sub_double_double(tmp74, tmp81);
  tmp82 = ats2jspre_gt_double_double(tmp78, tmp80);
  if(tmp82) {
    tmp83 = ats2jspre_div_double_double(tmp78, tmp80);
    test(tmp83);
    enemy_move(arg0, tmp83, 1.0, __patsfun_10__closurerize(arg0));
  } else {
    tmp86 = ats2jspre_div_double_double(tmp80, tmp78);
    enemy_move(arg0, 1.0, tmp86, __patsfun_11__closurerize(arg0));
  } // endif
  return/*_void*/;
} // end-of-function
...
//
  ...
  tmp89 = enemy_getPosition_X(arg0);
  tmp90 = enemy_getPosition_Y(arg0);
  tmp91 = ats2jspre_add_double_double(tmp89, arg1);
  tmp92 = ats2jspre_add_double_double(tmp90, arg2);
  enemy_setPosition(arg0, tmp91, tmp92);
  tmp94 = enemy_check_crash(arg0, tmp91, tmp92);
  // ATScaseofseq_beg
  tmplab_js = 1;
  while(true) {
    tmplab = tmplab_js; tmplab_js = 0;
    switch(tmplab) {
      ...
      // ATSbranchseq_beg
      case 3: // __atstmplab6
      if(!ATSCKpat_int(tmp94, 0)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 4030(line=175, offs=3) -- 4324(line=183, offs=6)");
      case 4: // __atstmplab7
      tmp95 = enemy_check_bound(arg0, tmp91, tmp92);
      // ATScaseofseq_beg
      tmplab_js = 1;
      while(true) {
        tmplab = tmplab_js; tmplab_js = 0;
        switch(tmplab) {
          // ATSbranchseq_beg
          case 1: // __atstmplab8
          if(!ATSCKpat_int(tmp95, 1)) { tmplab_js = 3; break; }
          case 2: // __atstmplab9
          enemy_remove(arg0);
          break;
          // ATSbranchseq_end
          ...
          if(!ATSCKpat_int(tmp95, 0)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 4169(line=180, offs=5) -- 4312(line=182, offs=85)");
...
//
  ...
  tmp98 = player_getPosition_X();
  tmp99 = player_getPosition_Y();
  tmp100 = enemy_getPosition_X(arg0);
  tmp101 = enemy_getPosition_Y(arg0);
  tmp103 = ats2jspre_eq_double_double(tmp98, tmp100);
  if(tmp103) {
    tmp102 = ats2jspre_eq_double_double(tmp99, tmp101);
  } else {
    tmp102 = false;
  } // endif
  if(tmp102) {
...
//
  // ATSdynload()
  // ATSdynloadflag_sta(_057_home_057_grad3_057_gladius_057_CS520_057_hwtest_057_SpaceInvaders_057_myGame_056_dats__dynloadflag(221))
