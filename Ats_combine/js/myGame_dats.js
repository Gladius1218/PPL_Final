...
//
  ...
  if(tmp19) {
    ...
    tmp22 = ats2jspre_add_int0_int0(tmp23, 100);
...
//
  ...
  tmp80 = calc_speed_x(tmp79);
  tmp81 = ats2jspre_mul_double_double(tmp79, tmp80);
  enemy_move(arg0, tmp80, tmp81, __patsfun_10__closurerize(arg0));
  return/*_void*/;
} // end-of-function
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      // ATSbranchseq_beg
      case 3: // __atstmplab6
      if(ATSCKptrisnull(tmp85)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 3442(line=155, offs=3) -- 3533(line=157, offs=18)");
      case 4: // __atstmplab7
      // ATSINSmove_void
      break;
      // ATSbranchseq_end
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      if(!ATSCKpat_int(tmp92, 0)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 3877(line=169, offs=3) -- 4172(line=177, offs=6)");
      ...
      while(true) {
        ...
        switch(tmplab) {
          ...
          if(!ATSCKpat_int(tmp93, 0)) ATSINScaseof_fail("/home/grad3/gladius/CS520/hwtest/SpaceInvaders/myGame.dats: 4016(line=174, offs=5) -- 4160(line=176, offs=86)");
